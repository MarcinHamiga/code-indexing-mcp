...
Kimi Code, Claude Desktop, OpenCode, KiloCode, Antigravity 2, Antigravity CLI, Muse Code,
Tabnine (IDE plugins), and Tabnine CLI. Configuration changes are
limited to the
...
(Claude Code, Kimi Code, Codex, OpenCode, Antigravity 2, Antigravity CLI, Muse Code, Tabnine CLI), pointing into the cloned repo so
