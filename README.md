...
Kimi Code, Claude Desktop, OpenCode, KiloCode, Antigravity 2, Antigravity CLI, and Muse Code. Configuration changes are
limited to the
...
(Claude Code, Kimi Code, Codex, OpenCode, Antigravity 2, Antigravity CLI, Muse Code), pointing into the cloned repo so
